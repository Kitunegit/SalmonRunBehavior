...
#fill
execute if score "$time_check" stage_change matches 0 run fill -63 28 62 126 28 -34 air 0 replace spl:face_water
 execute if score "$time_check" stage_change matches 16 run fill -63 29 62 126 29 -34 air 0 replace spl:face_water
 execute if score "$time_check" stage_change matches 30 run fill -63 30 62 126 30 -34 air 0 replace spl:face_water
 execute if score "$time_check" stage_change matches 44 run fill -63 31 62 126 31 -34 air 0 replace spl:face_water
 ...
 execute if score "$time_check" stage_change matches 0 run fill -63 28 -127 126 28 -34 air 0 replace spl:face_water
 execute if score "$time_check" stage_change matches 16 run fill -63 29 -127 126 29 -34 air 0 replace spl:face_water
 execute if score "$time_check" stage_change matches 30 run fill -63 30 -127 126 30 -34 air 0 replace spl:face_water
 execute if score "$time_check" stage_change matches 44 run fill -63 31 -127 126 31 -34 air 0 replace spl:face_water
